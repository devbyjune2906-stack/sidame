...
export function TambahKegiatanButton() {
      ...
      {open && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
          <div className="w-full max-w-lg rounded-xl border border-line bg-surface p-6 shadow-2xl">
            <h2 className="mb-5 font-display text-lg font-bold text-ink">Tambah Kegiatan</h2>

            {/* Judul */}
            <div className="mb-5">
              <label className="mb-1.5 block text-sm font-medium text-ink">Judul Kegiatan</label>
              <input
                value={judul}
            ...
            <div className="mb-5">
              ...
              {/* Daftar kolom yang sudah ditambahkan */}
              {kolom.length > 0 && (
              ...
              {kolom.length === 0 && (
                <p className="mt-1.5 text-xs text-muted">
                  Minimal 1 kolom harus ditambahkan.
                </p>
              )}
            </div>
