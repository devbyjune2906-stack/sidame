    ...
    <main className="flex min-h-screen items-center justify-center bg-petroleum-dark px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="mb-8 text-center text-white">
          <div className="mx-auto mb-3 flex h-16 w-16 items-center justify-center rounded-2xl bg-white/10 p-1.5 shadow-lg">
            <img src="/logo-dme.png" alt="DME" className="h-full w-full object-contain" />
          </div>
          <h1 className="font-display text-2xl font-bold tracking-tight">SIDAME</h1>
        ...
        <form action={formAction} className="rounded-2xl bg-surface p-6 shadow-card">
          ...
          <div className="mb-5 flex flex-col items-center gap-2 border-b border-line pb-5">
            <img src="/logo-dme.png" alt="KESDM — DME" className="h-14 w-14 object-contain" />
            <div className="text-center">
              <p className="text-[10px] font-semibold uppercase tracking-widest text-muted">
                Kementerian Energi dan Sumber Daya Mineral
              </p>
              <p className="mt-0.5 text-xs font-bold text-petroleum">
